(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      "td.cat.track-compare-cell{padding:0;vertical-align:bottom}",
      ".track-compare-stack{box-sizing:border-box;display:flex;",
      "flex-direction:column;width:100%;min-height:100%}",
      ".track-compare-main{box-sizing:border-box;margin-top:auto;padding:1px}",
      ".track-compare-boxes{display:flex;flex-direction:column;",
      "gap:0;margin:0;width:100%;flex:0 0 auto}",
      ".track-compare-box{box-sizing:border-box;min-height:2.35em;width:100%;",
      "max-width:none;padding:0;border:0;border-bottom:1px solid #808080;",
      "border-radius:0;background:transparent;color:#123;line-height:1.16;font-size:.56em;",
      "appearance:none;-webkit-appearance:none;text-align:center;overflow:visible;",
      "white-space:normal;overflow-wrap:anywhere;cursor:pointer}",
      ".track-compare-box:not(:empty){padding-bottom:.12em;",
  ...
  function renderBoxes() {
    ...
    Array.prototype.forEach.call(cells, function (cell) {
      var oldStack = cell.querySelector(".track-compare-stack");
      if (oldStack) {
        var oldMain = oldStack.querySelector(".track-compare-main");
        while (oldMain && oldMain.firstChild) {
          cell.insertBefore(oldMain.firstChild, oldStack);
        }
        oldStack.remove();
      }
      ...
      stack.className = "track-compare-stack";
      stack.style.minHeight = Math.max(0, Math.floor(height) - 2) + "px";
      ...
      main.className = "track-compare-main";
      while (cell.firstChild) {
        main.appendChild(cell.firstChild);
      }
