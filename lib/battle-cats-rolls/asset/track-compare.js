(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      ".track-compare-slot-label{display:inline-block;vertical-align:top;",
      "font-size:.72em;font-weight:normal;color:#666;line-height:1.2;",
      "max-width:26rem;max-height:2.4em;overflow:hidden;margin-left:.45rem}",
  ...
  function renderSlot(list, index, selected) {
    ...
    title.appendChild(document.createTextNode("확장 " + (index + 1)));
