(function (root, factory) {
  ...
  function normalizeFind(find) {
    ...
    var optimization = ["cost", "cost40", "cost50", "distance", "balance", "pareto"]
      .indexOf(find[0]) !== -1 ? find[0] : "cost";
    var seen = Object.create(null);
  ...
  function findFromSettings(settings) {
    ...
    return [
      ...
      settings.scheduleAware || settings.schedule_aware ? 1 : 0
    ];
  }
