(function (root, factory) {
  ...
  function calculateRoutePlan(items, preferredAuto) {
  ...
  function decorateMarks(container) {
    ...
    container.querySelectorAll(
      "td[data-plan-column-index][data-route-position]").forEach(function (cell) {
        ...
        var active = visible && !!selectedMark;
        var destinationKind = key && destinations[key];
        var showDestination = visible && !active && !!destinationKind;
        var showRoute = visible && !active && !showDestination && !!routeStep;
  ...
  function advanceRouteCandidates(engine, snapshot, starts, targetOffset,
    preferredColumn, preferredSteps, order, explored) {
    var buckets = [];
