(function (global) {
  ...
  function initialState() {
    ...
    if (saved) {
      ...
      saved.last = params.has("last") ?
        fromQuery.last : Math.max(0, intValue(saved.last, fromQuery.last));
  ...
  function updateUrl() {
    ...
    global.history.replaceState(null, "", "/multi?" + params.toString());
  }
  ...
  function readControlInputs() {
    ...
    return {
      ...
      count: clamped,
      last: Math.max(0, intValue(els.last.value, draft.last || 0)),
