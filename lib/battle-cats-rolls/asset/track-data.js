...
(function (global) {
  ...
  // Normalize params so equivalent requests share a cache key / URL. In
  // particular the form always submits ubers=0 (default) while the initial URL
  // omits it; treating '0' as empty avoids a needless /track.json refetch on
  // every seed change (which hangs offline).
