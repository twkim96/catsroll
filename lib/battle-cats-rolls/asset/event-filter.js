(function (global) {
  ...
  function init() {
    ...
    if (!template || !eventSelect || !form) return;
    ...
    function loadCatalog() {
      ...
      catalogPromise = global.fetch(
        ...
        catalog = Array.isArray(data.series) ? data.series : [];
    ...
    function renderAvailable() {
      ...
      var normalizedQuery = normalizeText(search.value);
